...
import 'package:komodo_ccxt_bridge/src/command_runner.dart';
...
void main() {
  group('KomodoCcxtBridgeCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late KomodoCcxtBridgeCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = KomodoCcxtBridgeCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = KomodoCcxtBridgeCommandRunner();
