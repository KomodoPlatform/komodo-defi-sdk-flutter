...
class OrderbookMethodsNamespace extends BaseRpcMethodNamespace {
  ...
  /// - [baseConfs]: Optional required confirmations for base coin
  /// - [baseNota]: Optional nota requirement for base coin
  /// - [relConfs]: Optional required confirmations for rel coin
  /// - [relNota]: Optional nota requirement for rel coin
  /// - [rpcPass]: Optional RPC password override
  /// 
