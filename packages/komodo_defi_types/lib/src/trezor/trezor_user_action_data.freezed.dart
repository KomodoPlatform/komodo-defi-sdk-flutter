...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TrezorUserActionData value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TrezorUserActionData value)?  $default,){
final _that = this;
switch (_that) {
case _TrezorUserActionData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TrezorUserActionType actionType, @SensitiveStringConverter()  SensitiveString? pin, @SensitiveStringConverter()  SensitiveString? passphrase)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrezorUserActionData() when $default != null:
return $default(_that.actionType,_that.pin,_that.passphrase);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TrezorUserActionType actionType, @SensitiveStringConverter()  SensitiveString? pin, @SensitiveStringConverter()  SensitiveString? passphrase)  $default,) {final _that = this;
switch (_that) {
case _TrezorUserActionData():
return $default(_that.actionType,_that.pin,_that.passphrase);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TrezorUserActionType actionType, @SensitiveStringConverter()  SensitiveString? pin, @SensitiveStringConverter()  SensitiveString? passphrase)?  $default,) {final _that = this;
switch (_that) {
case _TrezorUserActionData() when $default != null:
return $default(_that.actionType,_that.pin,_that.passphrase);case _:
  return null;
